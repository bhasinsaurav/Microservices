...
public class CardsController {
    ...
    public CardsController(CardsContactInfoDto cardsContactInfoDto, ICardsService iCardsService, Environment environment) {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("eazybank-correlation-id") String correlationId ,
        ...
        logger.debug("eazyBank-correlation_id found: {}", correlationId);
